...
public class PageMaker {
	...
	private int cntPageNum = 10;     // 한 화면에 보이는 페이지 버튼의 수
	...
	// 화면에서 페이지 번호를 클릭하면, URL의 QueryString에 페이지 번호와 페이지당 항목 수를 조립해 주는 메소드
	// ex) 화면 페이지: 3 -> 반환 예: ?pageNum=3&rowsPerPage=10
